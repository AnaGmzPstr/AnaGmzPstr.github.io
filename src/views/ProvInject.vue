<template>
    <div class="container">
        ...
        <hr>
        <h2>Ejercicio 1: cambio de color</h2>
        <CambioColor/>
        <hr>
...
provide('color', color);
provide('setColor', (newColor)=>{
    color.value = newColor;
})

// Ejercicio 2
import ContadorPadre from '@/components/ContadorComp.vue';
// Variable reactiva
const contador = ref(0);
// Proveer el contador
provide('contador', contador);
// Proveer funciones que incrementan y decrementan
provide('incrementar', () => {
    contador.value++;
});
provide('decrementar', () =>{
